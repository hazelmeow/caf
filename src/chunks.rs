...
pub fn can_decode_chunk_type(chunk_type: ChunkType) -> bool {
    use ChunkType::*;
    match chunk_type {
        AudioDescription | AudioData | PacketTable | ChannelLayout | MagicCookie | Info => true,
        _ => false,
    }
}
...
pub fn decode_chunk(
    ...
    match chunk_type {
        ...
        ChunkType::AudioData => {
            ...
            Ok(CafChunk::AudioDataInMemory(edit_count, chunk_content))
        }
        ...
        ChunkType::MagicCookie => Ok(CafChunk::MagicCookie(chunk_content)),
        // ...
        ChunkType::Info => {
            let mut rdr = Cursor::new(&chunk_content);
